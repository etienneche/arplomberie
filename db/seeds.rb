      ...
      10.times { |index| User.create( phone: rand(1..10) , name: Faker::Name.unique.name , address: Faker::Lorem.paragraph(sentence_count: 8) , role: Faker::Lorem.sentence(word_count: 5)  , email: "#{index}@email.com" , password: 'password' ) }
